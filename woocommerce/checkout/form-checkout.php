...
<div class="min-h-screen bg-gray-50">
	<div class="max-w-7xl xl:max-w-[95rem] 2xl:max-w-[110rem] mx-auto px-2 sm:px-6 lg:px-8 py-4 sm:py-8">
			...
			<div class="lg:grid lg:grid-cols-3 lg:gap-8">
				...
				<div class="lg:col-span-1">
					<div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200 shadow-sm p-6 sticky top-8">
						...
						<div id="order_review" class="woocommerce-checkout-review-order rounded-lg border border-gray-100">
