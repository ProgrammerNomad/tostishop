                        ...
                        <div class="space-y-4">
                            ...
                            <div class="group flex justify-between items-center p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100 hover:border-blue-200 transition-all duration-200">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="text-base font-semibold text-blue-900"><?php _e('Subtotal', 'woocommerce'); ?></span>
                                        <p class="text-xs text-blue-700 mt-0.5"><?php _e('Items total before shipping', 'tostishop'); ?></p>
                                    </div>
                                </div>
                            ...
                            <div class="bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl p-4 border border-gray-200">
                                <div class="flex items-center justify-between mb-3">
                                    <h4 class="text-sm font-semibold text-gray-900 flex items-center">
                                        <div class="flex items-center justify-center w-8 h-8 bg-primary/10 rounded-lg mr-2">
                                    ...
                                    <button type="button" class="px-3 py-1.5 text-primary text-sm font-medium hover:text-primary/80 transition-colors bg-primary/10 rounded-lg hover:bg-primary/15" id="toggle-coupon">
                            ...
                            <?php foreach (WC()->cart->get_coupons() as $code => $coupon) : ?>
                                <div class="flex justify-between items-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 hover:border-green-300 transition-all duration-200">
                                    <span class="text-green-800 font-semibold flex items-center">
                                        ...
                                        <div>
                                            <div class="font-semibold"><?php echo apply_filters('woocommerce_cart_totals_coupon_label', esc_html($coupon->get_code()), $coupon); ?></div>
                                            <div class="text-xs text-green-600"><?php _e('Discount applied', 'tostishop'); ?></div>
                                        </div>
                                    </span>
                            ...
                            <?php if (WC()->cart->needs_shipping() && WC()->cart->show_shipping()) : ?>
                                <div class="group p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl border border-purple-100 hover:border-purple-200 transition-all duration-200">
                                    <div class="flex items-center mb-3">
                                        ...
                                        <div>
                                            <span class="text-base font-semibold text-purple-900"><?php _e('Shipping', 'woocommerce'); ?></span>
                                            <p class="text-xs text-purple-700 mt-0.5"><?php _e('Choose your delivery method', 'tostishop'); ?></p>
                                        </div>
                                    </div>
                            ...
                            <div class="relative overflow-hidden mt-6">
                                <div class="order-total-section group flex justify-between items-center p-6 rounded-xl border-2 bg-gradient-to-r from-navy-900 via-navy-800 to-blue-900 text-white shadow-xl">
                                    ...
                                    <div class="flex items-center relative z-10">
                                        ...
                                        <div>
                                            <span class="text-xl font-bold text-white"><?php _e('Total', 'woocommerce'); ?></span>
                                            <p class="text-white/70 text-sm mt-0.5"><?php _e('Final amount to pay', 'tostishop'); ?></p>
                                        </div>
                                    </div>
                                    
                                    <div class="text-right relative z-10">
                                        <span class="text-2xl font-bold text-white drop-shadow-sm"><?php wc_cart_totals_order_total_html(); ?></span>
                                        <p class="text-white/70 text-xs mt-1"><?php _e('Including all taxes', 'tostishop'); ?></p>
                                    </div>
