                    ...
                    <div class="rounded-2xl overflow-hidden">
                        ...
                        <div class="p-8" x-data="{ currentView: 'initial', isRegistering: false }">
                            ...
                            <div x-show="currentView === 'initial'" x-transition class="space-y-6 px-1 py-1">
                                ...
                                <!-- 2. Login with Google Button (Redesigned to match standard Google login button) -->
                                <button id="google-login-btn" 
                                        class="w-full bg-white border border-gray-300 text-gray-700 py-3 rounded-lg font-medium hover:bg-gray-50 hover:shadow-sm focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 transition-all duration-200 flex items-center justify-center">
                                ...
                                <button @click="currentView = 'email'" 
                                        class="w-full bg-gray-100 border border-gray-300 text-gray-700 py-3 rounded-lg font-semibold hover:bg-gray-200 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-200 flex items-center justify-center">
