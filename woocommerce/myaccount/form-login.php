                ...
                <div class="max-w-md mx-auto lg:max-w-lg">
                    ...
                    <div class="rounded-2xl overflow-hidden">
                        ...
                        <div class="p-8" x-data="{ currentView: 'initial', isRegistering: false }">
                            ...
                            <div x-show="currentView === 'initial'" x-transition class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <div class="absolute inset-y-0 left-0 flex items-center pointer-events-none pl-3">
                                                <span class="text-navy-900 text-sm font-medium bg-gray-100 px-2 py-2 rounded-l-lg border-r">
                                                    +91
                                                </span>
                                            </div>
                                            <input type="tel" 
                                                   id="mobile-number" 
                                                   name="mobile-number" 
                                                   class="pl-16 w-full py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-navy-500 focus:border-navy-500 text-base"
                                ...
                                <button id="google-login-btn" 
                                        class="w-full bg-white border-2 border-gray-200 text-gray-700 py-4 px-6 rounded-lg font-semibold hover:bg-gray-50 hover:border-gray-300 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-200 flex items-center justify-center">
                                ...
                                <!-- 3. Login with Email & Password Button -->
                                <button @click="currentView = 'email'" 
                                        class="w-full bg-gray-100 border border-gray-300 text-gray-700 py-4 px-6 rounded-lg font-semibold hover:bg-gray-200 hover:border-gray-400 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-all duration-200 flex items-center justify-center">
                            ...
                            <div x-show="currentView === 'otp'" x-transition class="space-y-6">
                                ...
                                <div class="space-y-3">
                                    <button id="verify-otp-btn" 
                                            class="w-full bg-accent text-white py-4 px-4 rounded-lg font-semibold hover:bg-red-600 focus:ring-2 focus:ring-accent focus:ring-offset-2 transition-all duration-200">
                                        Verify OTP
                                    </button>
                            ...
                            <div x-show="currentView === 'email'" x-transition class="space-y-6">
                                ...
                                <div x-show="!isRegistering" class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="password" 
                                                   id="password-login" 
                                                   name="password-login" 
                                                   class="w-full py-3 px-3 pr-10 border border-gray-300 rounded-lg focus:ring-2 focus:ring-navy-500 focus:border-navy-500"
                                                   placeholder="••••••••"
                                                   required>
                                            <button type="button" 
                                    ...
                                    <button id="email-login-btn" 
                                            class="w-full bg-navy-900 text-white py-3 px-4 rounded-lg font-semibold hover:bg-navy-800 focus:ring-2 focus:ring-navy-500 focus:ring-offset-2 transition-all duration-200">
                                        Sign In
                                    </button>
                                ...
                                <div x-show="isRegistering" class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="password" 
                                                   ...
                                                   class="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-navy-500 focus:border-navy-500"
                                                   placeholder="••••••••"
                                                   required>
                                            <button type="button" 
                                    ...
                                    <button id="email-register-btn" 
                                            class="w-full bg-accent text-white py-3 px-4 rounded-lg font-semibold hover:bg-red-600 focus:ring-2 focus:ring-accent focus:ring-offset-2 transition-all duration-200">
                                        Register & Continue
                                    </button>
