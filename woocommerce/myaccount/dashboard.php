...
<div class="woocommerce-MyAccount-dashboard bg-white">
	...
	<!-- Welcome Header -->
	<div class="bg-gradient-to-r from-primary to-blue-600 text-white rounded-lg p-6 mb-8">
		<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
			...
			<div class="mt-4 sm:mt-0">
				<div class="bg-white bg-opacity-20 rounded-lg p-3 text-center">
					<div class="text-sm text-blue-100"><?php _e( 'Member since', 'tostishop' ); ?></div>
					<div class="font-semibold"><?php echo date_i18n( 'F Y', strtotime( $current_user->user_registered ) ); ?></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
		...
		<a href="<?php echo esc_url( wc_get_page_permalink( 'shop' ) ); ?>" 
		   class="block p-6 bg-white border border-gray-200 rounded-lg hover:shadow-md transition-shadow duration-200 group">
			<div class="flex items-center">
				<div class="flex-shrink-0">
					<svg class="w-8 h-8 text-primary group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
					</svg>
				</div>
				<div class="ml-4">
					<h4 class="text-lg font-medium text-gray-900"><?php _e( 'Browse Products', 'tostishop' ); ?></h4>
					<p class="text-sm text-gray-600"><?php _e( 'Discover our latest products', 'tostishop' ); ?></p>
				</div>
			</div>
		</a>
		...
		<a href="<?php echo esc_url( wc_get_account_endpoint_url( 'edit-account' ) ); ?>" 
		   class="block p-6 bg-white border border-gray-200 rounded-lg hover:shadow-md transition-shadow duration-200 group">
			<div class="flex items-center">
				...
				<div class="ml-4">
					<h4 class="text-lg font-medium text-gray-900"><?php _e( 'Edit Profile', 'tostishop' ); ?></h4>
					<p class="text-sm text-gray-600"><?php _e( 'Update your account details', 'tostishop' ); ?></p>
				</div>
			</div>
		</a>
		...
		<a href="<?php echo esc_url( wc_get_account_endpoint_url( 'edit-address' ) ); ?>" 
		   class="block p-6 bg-white border border-gray-200 rounded-lg hover:shadow-md transition-shadow duration-200 group">
			<div class="flex items-center">
				...
				<div class="ml-4">
					<h4 class="text-lg font-medium text-gray-900"><?php _e( 'Manage Addresses', 'tostishop' ); ?></h4>
					<p class="text-sm text-gray-600"><?php _e( 'Update billing & shipping', 'tostishop' ); ?></p>
				</div>
			</div>
		</a>
	</div>
