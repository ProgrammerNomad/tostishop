    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-3xl mx-auto text-lg">
                    Passionate professionals dedicated to bringing you the best beauty shopping experience
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200 text-center hover:shadow-md transition-shadow">
                    <div class="w-24 h-24 bg-gradient-to-br from-navy-900 to-navy-800 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold text-white">
                        R
                    </div>
                    <h3 class="text-xl font-semibold text-navy-900 mb-2">Rahul Sharma</h3>
                    <p class="text-accent font-medium mb-3">Founder & CEO</p>
                    <p class="text-gray-600 leading-relaxed">
                        Visionary leader with 8+ years in e-commerce, passionate about democratizing beauty and building customer-centric solutions.
                    </p>
                </div>

                <!-- Team Member 2 -->
                <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200 text-center hover:shadow-md transition-shadow">
                    <div class="w-24 h-24 bg-gradient-to-br from-accent to-red-600 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold text-white">
                        P
                    </div>
                    <h3 class="text-xl font-semibold text-navy-900 mb-2">Priya Mehta</h3>
                    <p class="text-accent font-medium mb-3">Head of Operations</p>
                    <p class="text-gray-600 leading-relaxed">
                        Operations expert ensuring seamless order fulfillment, supply chain optimization, and exceptional delivery experiences.
                    </p>
                </div>

                <!-- Team Member 3 -->
                <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200 text-center hover:shadow-md transition-shadow">
                    <div class="w-24 h-24 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold text-white">
                        A
                    </div>
                    <h3 class="text-xl font-semibold text-navy-900 mb-2">Amit Kumar</h3>
                    <p class="text-accent font-medium mb-3">Technology Lead</p>
                    <p class="text-gray-600 leading-relaxed">
                        Tech innovator developing cutting-edge solutions for enhanced user experience, AI recommendations, and platform scalability.
                    </p>
                </div>
            </div>
        </div>
