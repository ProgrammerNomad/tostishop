            ...
            <div class="lg:col-span-1">
                <div class="mb-6">
                    ...
                    <div class="flex space-x-4">
                        <!-- Facebook -->
                        <a href="https://www.facebook.com/tostishop" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-navy-800 hover:bg-accent rounded-lg flex items-center justify-center transition-colors duration-300 group" title="Follow us on Facebook @tostishop">
                        ...
                        <!-- Instagram -->
                        <a href="https://www.instagram.com/tostishop" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-navy-800 hover:bg-accent rounded-lg flex items-center justify-center transition-colors duration-300 group" title="Follow us on Instagram @tostishop">
                            <svg class="w-5 h-5 text-silver-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Pinterest -->
                        <a href="https://www.pinterest.com/tostishop" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-navy-800 hover:bg-accent rounded-lg flex items-center justify-center transition-colors duration-300 group" title="Follow us on Pinterest @tostishop">
                            <svg class="w-5 h-5 text-silver-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
