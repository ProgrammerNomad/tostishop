        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
                ...
                <div class="space-y-4">
                    ...
                    <!-- Post-Login Section -->
                    <div class="bg-navy-800/30 rounded-lg p-4 border border-navy-700">
                        <h4 class="text-sm font-semibold text-silver-200 mb-3">Account Management</h4>
                        <ul class="space-y-2">
                            <li><a href="https://www.tostishop.com/my-account/edit-account/" class="text-silver-300 hover:text-white text-sm transition-colors duration-300 flex items-center group">
                            ...
                            <li><a href="https://www.tostishop.com/my-account/orders/" class="text-silver-300 hover:text-white text-sm transition-colors duration-300 flex items-center group">
                                <svg class="w-3 h-3 text-silver-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <li><a href="https://www.tostishop.com/my-account/edit-address/" class="text-silver-300 hover:text-white text-sm transition-colors duration-300 flex items-center group">
                                <svg class="w-3 h-3 text-silver-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
