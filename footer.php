            ...
            <div class="lg:col-span-1">
                <div class="mb-4 md:mb-6">
                    ...
                    <div class="flex space-x-3 md:space-x-4">
                        ...
                        <!-- Instagram -->
                        <a href="https://www.instagram.com/tostishops" target="_blank" rel="noopener noreferrer" class="w-8 h-8 md:w-10 md:h-10 bg-navy-800 hover:bg-accent rounded-lg flex items-center justify-center transition-colors duration-300 group" title="Follow us on Instagram @tostishop">
                            <svg class="w-4 h-4 md:w-5 md:h-5 text-silver-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Pinterest -->
                        <a href="https://www.pinterest.com/tostishops" target="_blank" rel="noopener noreferrer" class="w-8 h-8 md:w-10 md:h-10 bg-navy-800 hover:bg-accent rounded-lg flex items-center justify-center transition-colors duration-300 group" title="Follow us on Pinterest @tostishop">
                            <svg class="w-4 h-4 md:w-5 md:h-5 text-silver-300 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
