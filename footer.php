    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="https://www.tostishop.com/about-us/" class="text-silver-200 hover:text-accent transition-colors duration-300 flex items-center group">
                        <span class="w-2 h-2 bg-accent rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                        About Us
                    </a></li>
                    <li><a href="https://www.tostishop.com/press-releases/" class="text-silver-200 hover:text-accent transition-colors duration-300 flex items-center group">
                        <span class="w-2 h-2 bg-accent rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                        Press Releases
                    </a></li>
                    <li><a href="https://www.tostishop.com/careers/" class="text-silver-200 hover:text-accent transition-colors duration-300 flex items-center group">
                        <span class="w-2 h-2 bg-accent rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                        Careers
                    </a></li>
                    <li><a href="https://www.tostishop.com/gift-a-smile/" class="text-silver-200 hover:text-accent transition-colors duration-300 flex items-center group">
                        <span class="w-2 h-2 bg-accent rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                        Gift a Smile
                    </a></li>
                </ul>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="https://www.tostishop.com/contact-us/" class="text-silver-200 hover:text-accent transition-colors duration-300 flex items-center group">
                        <span class="w-2 h-2 bg-accent rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                        Contact Us
                    </a></li>
                    <li><a href="https://www.tostishop.com/100-purchase-protection/" class="text-silver-200 hover:text-accent transition-colors duration-300 flex items-center group">
                        <span class="w-2 h-2 bg-accent rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                        100% Purchase Protection
                    </a></li>
                    <li><a href="https://www.tostishop.com/shipping-policy/" class="text-silver-200 hover:text-accent transition-colors duration-300 flex items-center group">
                        <span class="w-2 h-2 bg-accent rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                        Shipping Policy
                    </a></li>
                    <li><a href="https://www.tostishop.com/refund-and-returns-policy/" class="text-silver-200 hover:text-accent transition-colors duration-300 flex items-center group">
                        <span class="w-2 h-2 bg-accent rounded-full mr-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                        Returns & Refunds
                    </a></li>
                </ul>
