...
/**
 * Check if the function exists before declaring it to prevent redeclaration
 */
if (!function_exists('tostishop_enqueue_firebase_scripts')) {
    /**
    ...
    function tostishop_enqueue_firebase_scripts() {
        ...
        wp_localize_script('tostishop-firebase-auth', 'tostiShopDevMode', array(
            'enabled' => defined('TOSTISHOP_DEV_MODE') && TOSTISHOP_DEV_MODE
        ));
...
/**
 * Add Firebase scripts only on relevant pages - RENAME THIS TO AVOID CONFLICT
 */
